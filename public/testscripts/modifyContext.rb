...
@@opts = Trollop::options do
  opt :path, "Change path", :default => '/user/heikki/contexts/Vacation', :type => String
  ...
  opt :method, "Change request method", :default => 'post'
  opt :parameters, "Change params", :default => "metadata=tag/summer", :type => String
end
