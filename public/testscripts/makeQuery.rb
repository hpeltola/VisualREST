...
@@opts = Trollop::options do
  opt :path, "Change path", :default => '/files', :type => String
  opt :uri, "Change uri", :default => 'http://localhost:8080/files', :type => String
  opt :password, "Change password", :default => 'heikki'
  opt :username, "Change username", :default => 'heikki'
  opt :method, "Change request method", :default => 'get'
  opt :parameters, "Change params", :default => "type=jpg&updatedAfter=1980", :type => String
end
